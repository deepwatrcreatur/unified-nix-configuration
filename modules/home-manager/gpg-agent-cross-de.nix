...
{
  # Cross-DE GPG agent configuration
  # Works on GNOME, KDE, XFCE, and other desktop environments
  # Uses GTK2 pinentry which is widely compatible

  home.packages = with pkgs; [
    pinentry-gtk2 # Cross-DE compatible pinentry
  ];
  ...
  services.gpg-agent = {
    ...
    # This allows agents to commit without re-prompting
  ...
  home.file.".local/bin/gpg-cache-passphrase" = {
    ...
    text = ''
      ...
      # Useful before running agents that will make commits via SSH
