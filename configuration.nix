...

{
  imports = [
    ...
    # Temporarily disable modular imports to fix boot issues
  ...
  # Modular inference configuration temporarily disabled to fix boot issues
  # TODO: Re-enable after fixing module evaluation problems
  #
