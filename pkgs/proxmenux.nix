# pkgs/proxmenux.nix
# ProxMenux - Interactive menu for Proxmox VE
{ lib, stdenvNoCC, fetchFromGitHub, bash, coreutils, curl, wget, jq, newt, git, iproute2 }:
...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    ...
    export PATH="${lib.makeBinPath [ bash coreutils curl wget jq newt git iproute2 ]}:\$PATH"
