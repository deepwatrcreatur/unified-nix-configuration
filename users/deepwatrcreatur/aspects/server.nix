# users/deepwatrcreatur/aspects/server.nix
# Reusable Home Manager headless server persona aspect:
# Minimal CLI environment, age-decrypted token, and basic terminal utilities for server/router nodes.
{
  config,
  pkgs,
  lib,
