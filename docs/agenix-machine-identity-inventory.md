...
| vaglio | `agenix machine identity - vaglio` | `/var/lib/agenix/machine-identity` | `ssh-keys/agenix-machine-identities/vaglio.pub` | `ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIAyUmuSOU3HPNUjRatZIE+y00exzQFqgMM+6DDGHzKO5 agenix-machine-identity vaglio` |
